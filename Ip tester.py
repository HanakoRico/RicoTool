...
def ping_ip(ip, threads=4):
    ...
    typewriter(f"\nUltra-hard pinging {ip} with {threads} threads...\n")
...
while True:
    ...
    # -------- MENU 2 OPTIONS -------- #
        ...
        if menu == "5":
            ...
            ip = input("Enter IP address to ultra-hard ping: ").strip()
            if ip:
                ping_ip(ip, threads=4)  # you can increase threads for even more intense pinging
            else:
