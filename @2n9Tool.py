...
def print_menu(menu_num):
    ...
    if menu_num == 1:
        content = f'''
print(f"{Fore.CYAN}  ,ad88PPP88ba,      ad888888b,                  ad88888ba                                        88  ")
print(f"{Fore.CYAN} d8\"  .ama.a \"8a  d8\"     \"88             d8\"     \"88     ,d                              88  ")
print(f"{Fore.BLUE}d8'  ,8P\"88\"  88          a8P               8P       88       88                              88  ")
print(f"{Fore.BLUE}88  .8P  8P   88       ,d8P\"   8b,dPPYba,   Y8,    ,d88     MM88MMM  ,adPPYba,    ,adPPYba,   88  ")
print(f"{Fore.CYAN}88  88   8'   8P     a8P\"     88P'   `\"8a \"PPPPPP\"88      88    a8\"     \"8a a8\"     \"8a  88  ")
print(f"{Fore.CYAN}88  8B ,d8 ,ad8'   a8P'        88       88           8P       88    8b       d8  8b       d8  88  ")
print(f"{Fore.BLUE}\"8a \"88P\"888P\" d8\"        88       88  8b,    a8P        88,   \"8a,   ,a8\"\"8a,   ,a8\"  88  ")
print(f"{Fore.BLUE} `Y8aaaaaaaad8P   88888888888  88       88  `\"Y8888P'         \"Y888  `\"YbbdP\"' `\"YbbdP\"'   88  ")
print(f"{Fore.CYAN}    \"\"\"\"\"\"\"\"\"                                                                                     ")
print(f"{Fore.CYAN}                                                                                                   ")
